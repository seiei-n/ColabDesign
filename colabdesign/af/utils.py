...
class _af_utils:  
  ...
  # plotting functions
  #-------------------------------------
  def animate(self, s=0, e=None, dpi=100, get_best=True, traj=None, aux=None, color_by="plddt", out_dir=None, rclimit: int = None):
    '''
    ...
    return make_animation(**sub_traj, pos_ref=pos_ref, length=self._lengths,
                          color_by=color_by, align_xyz=align_xyz, dpi=dpi, out_dir=out_dir, rclimit=rclimit)
